...
class RestaurantAccessScreen extends StatelessWidget {
  ...
  Widget _buildContent() {
    return switch (appStatus) {
      AppStatus.checkingRestaurantAccess => const Center(
        child: CircularProgressIndicator(),
      ),
      AppStatus.restaurantAccessPending => AccessRequestPendingView(
        onRefresh: onRetry,
      ),
      AppStatus.restaurantAccessFailure => AppStateMessage(
        icon: AppIcons.cloud_off_rounded,
        title: 'Could not check restaurant access',
        message: failureMessage ?? 'Check your connection and try again.',
